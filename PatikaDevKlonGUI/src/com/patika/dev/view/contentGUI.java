...
public class contentGUI extends JFrame {
    ...
    public contentGUI(int courseId){
        ...
        //Ekleme
        btn_educator_content.addActionListener(e -> {
            if (Helper.isFieldEmpty(field_educator_title) || Helper.isFieldEmpty(field_educator_description) ||Helper.isFieldEmpty(field_educator_yt)){
                Helper.showMassage("fill");
            }else {
                int crsID=courseID;
                String title=field_educator_title.getText();
                String description=field_educator_description.getText();
                String youtubeLink=field_educator_yt.getText();

                if (Content.add(crsID,title,description,youtubeLink)){
                    Helper.showMassage("done");
                    loadContent(courseID);

                    field_educator_title.setText(null);
                    field_educator_description.setText(null);
                    field_educator_yt.setText(null);
                }
    ...
    public static void main(String[] args) {
        Helper.setLayout();
        contentGUI contentGUI=new contentGUI(24);
    }
